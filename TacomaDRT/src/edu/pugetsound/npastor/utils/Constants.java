...
public class Constants {
	...
	// The biggies!
	public final static int TOTAL_TRIPS = 1000;
	public final static int ALL_DAY_FLEET_SIZE = 3; // Minimum DRT fleet size across day
	public final static int PEAK_FLEET_SIZE_ADDITION = 3; // Additional vehicles to be added during peak hours
	
	// Agency constants
	public final static int BEGIN_OPERATION_HOUR = 5; // Service begins at this hour
	public final static int END_OPERATION_HOUR = 22; // (7:00 PM) Service ends at this hour
	public final static int BEGIN_REQUEST_WINDOW = 0; // Time when riders can begin to make requests
	public final static int END_REQUEST_WINDOW = 21; // Cutoff time for making request known to agency for the day
